...
interface DepartmentAutoCompleteProps {
  ...
  setSelectDepartment: React.Dispatch<any>;
  objForm: UseFormReturn<any>;
  ...
  return (
    <div>
      <Autocomplete
        ...
        onChange={(_, data) => {
          props.setSelectDepartment(data);
        }}
        defaultValue={props.objAppointment?.Department.map(
          (item: IDepartment) => item
        )}
      />
      <FormHelperText style={{ color: "red" }}>
        {/* {props.objForm.formState.errors.?.message} */}
      </FormHelperText>
    </div>
  );
}
